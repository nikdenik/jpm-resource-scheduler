...
public class TestTwoResourceAndOddEvenPriorityStrategy {

	private ResourceScheduler scheduler = new ResourceScheduler(2, PriorityStrategyFactory.getOddAndEvenMessageIDPriorityStrategy());
	
	
	@Test
	public void testSendMoreMessagesTwoResourcesAndOddEvenPriorityStrategy() {
